...
![StockChart](PAGS_YahooFinanceChart.png)
...
Now for comparison, this is the Brazilian real against the dollar: 
...
Two new offerings could help bring to PagSeguro not only new users, an increase in both customer loyalty and cross-selling opportunities, but also shareholder equity in the long run via diversification of deposits. 
